...
class DataArguments:
    ...
    prompt_type: str = field(default="alpaca", metadata={"help": "Prompt type."})
...
class SupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str, tokenizer: transformers.PreTrainedTokenizer, prompt_type: str):
        ...
        if prompt_type == "alpaca":
            ...
            logging.warning(f"{prompt_type} is not supported.")
...
def train():
    ...
    assert "llama" in model_args.model_name_or_path
